...
# Calibration_scipt_v3 includes a new way to get the intrinsics of the Realsence camera.
...
cfg = rs.config()
cfg.enable_stream(rs.stream.color, 1280, 720, rs.format.bgr8, 30)  # higher res
